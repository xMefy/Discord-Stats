    ...
    if (
      ...
      async function startUpload() {
        ...
        if (isDebug) {
          ...
          setLoading("Loading Your Data File");
          await delay(2000);
        }
        ...
        if (isDebug) setLoading("Loading Data|||Registering Package");
        ...
        if (isDebug) {
          ...
          await delay(50);
          setLoading("Loading Data|||Initializing file reader");
        }
        ...
        if (isDebug) {
          ...
          await delay(50);
          setLoading("Loading Data|||Checking for Valid Package");
